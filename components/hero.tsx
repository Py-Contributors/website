  ...
  return (
    <div className="relative">
      <div className="mx-auto max-w-md px-6 sm:max-w-3xl lg:max-w-7xl lg:px-8">
        <div className="relative overflow-hidden rounded-2xl bg-[#0f4db2] px-6 py-10 shadow-xl sm:px-12 sm:py-20">
          <div aria-hidden="true" className="absolute inset-0 -mt-72 sm:-mt-32 md:mt-0">
            ...
            >
              <path
                className="text-[#54c5f6] text-opacity-40"
                fill="currentColor"
          ...
          <div className="relative">
            ...
            <div className="mt-6 justify-center flex items-center scale-110">
              <button
                type="submit"
                className="rounded-md bg-blue-300 px-3.5 py-2 text-lg font-bold leading-7 text-black shadow-sm hover:bg-blue-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-300"
              >
                Get Started
              </button>
            </div>
